...
afo_base_image_name="registryonline-hulk.sankuai.com/custom_prod/com.sankuai.data.hadoop.gpu/data-hadoop-hmart-hdp_afo-base-julang:download_monitor"
afo_docker_image_name="registryonline-hulk.sankuai.com/custom_prod/com.sankuai.data.hadoop.gpu/data-hadoop-hdp_tf1.15_mt_julang_1.0.0_cuda11.0_runtime-5181436e"
...
${hope_submit} run --xml ${exp}/${dist_xml_name} \
                   ...
                   -Dafo.data.packet.download.timeout=30 \
                   -Dargs.use_cog=True \
                   -Ddistribute.mode=mpi \
                    ...
                    -Dafo.data.dispatch.policy1="com.meituan.hadoop.afo.tensorflow.data.policy.FixedOrderPolicy" \
